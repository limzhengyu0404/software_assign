    ...
    <main id="main" class="main">
        ...
        <section class="container section">
            ...
            <div class="d-flex justify-content-evenly align-items-between pb-md-0 pb-3 row">
                <div class="card border border-0 col-md-2 col-sm-5 col-12 d-flex justify-content-center" style="background-color:#ffcc00">
                ...
                <div class="card border border-0 col-md-2 col-sm-5 col-12 d-flex justify-content-center" style="background-color:#0099ff">
                ...
                <div class="card border border-0 col-md-2 col-sm-5 col-12 d-flex justify-content-center" style="background-color:#00ff00">
                    <div class="text-white text-center">
                        <div>Active</div>
                        <h3><?php echo $active_status ?></h3>
                    </div>
                </div>
                <div class="card border border-0 col-md-2 col-sm-5 col-12 d-flex justify-content-center" style="background-color:#ff0000">
                    <div class="text-white text-center">
                        <div>Closed</div>
            ...
            <?php 
                if ($role=='helpdesk' || $role=='admin' || $helpdesk==true) {
                    ...
                    echo "<div class='text-decoration-underline py-4'>Complaint Execution</div>
                            <div class='d-flex justify-content-evenly align-items-between pb-md-0 pb-3 row'>
                                <div class='card bg-gradient border border-0 hover-blacktogrey col-md-2 col-sm-5 col-12 d-flex justify-content-center bg-warning'>
                                    <div class='text-white text-center'>
                                        <div>Pending</div>
                                        <h3>$executive_pending_status</h3>
                                    </div>
                                </div>
                                <div class='card border border-0 hover-greytoback col-md-2 col-sm-5 col-12 d-flex justify-content-center' style='background-color:#0099ff'>
                                    <div class='text-white text-center'>
                                        <div>Keep In View</div>
                                ...
                                <div class='card border border-0 hover-blacktogrey col-md-2 col-sm-5 col-12 d-flex justify-content-center' style='background-color:#00ff00'>
                                    <div class='text-white text-center'>
                                        <div>Active</div>
                                        <h3>$executive_active_status</h3>
                                    </div>
                                </div>
                                <div class='card border border-0 hover-greytoback col-md-2 col-sm-5 col-12 d-flex justify-content-center' style='background-color:#ff0000'>
                                    <div class='text-white text-center'>
                                        <div>Closed</div>
